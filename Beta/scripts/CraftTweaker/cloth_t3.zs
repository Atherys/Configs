...
<minecraft:bow>.withTag({HideFlags: 2, SpongeData: {CustomManipulators: [{ContentVersion: 2, ManipulatorId: "atherysrpg:attributes", ManipulatorData: {ContentVersion: 1, Attributes: {"atherys:base_damage": 15.0}}}]}, display: {Lore: ["§7Bow (Main Hand)", "", "§c▶ Physical Damage§7: 15.0", "", "§fCommon"], Name: "§fCommon Bow"}}).maxDamage = 5;
