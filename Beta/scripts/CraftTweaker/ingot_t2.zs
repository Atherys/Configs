...
val ingot = <atherys:ingot_t2>.withTag({HideFlags: 2, display: {Lore: ["", "§7Can be crafted into §9Steel§7 Items."], Name: "§9Steel Ingot"}});
val stick = <minecraft:stick>;
val gem = <minecraft:dye:4>.withTag({display: {Name: "§r§9Lapis Lazuli"}});

val helmet = <atherys:heavy_t2_helmet>.withTag({HideFlags: 2, SpongeData: {CustomManipulators: [{ContentVersion: 2, ManipulatorId: "atherysrpg:attributes", ManipulatorData: {ContentVersion: 1, Attributes: {"atherys:physical_resistance": 8.7, "atherys:speed_multiplier": -1.0, "atherys:healing_rate": 1.8, "atherys:magical_resistance": 5.8}}}]}, display: {Lore: ["§7Heavy Armor", "", "§c▶ Physical Resistance§7: +8.7%", "§3▶ Magical Resistance§7: +5.8%", "", "§a+1.8% §7Healing Rate", "§c-1.0% §7Movement Speed", "", "§9Uncommon"], Name: "§9Steel Helm"}});
val chest = <atherys:heavy_t2_body>.withTag({HideFlags: 2, SpongeData: {CustomManipulators: [{ContentVersion: 2, ManipulatorId: "atherysrpg:attributes", ManipulatorData: {ContentVersion: 1, Attributes: {"atherys:physical_resistance": 14.1, "atherys:speed_multiplier": -1.6, "atherys:healing_rate": 3.0, "atherys:magical_resistance": 9.3}}}]}, display: {Lore: ["§7Heavy Armor", "", "§c▶ Physical Resistance§7: +14.1%", "§3▶ Magical Resistance§7: +9.3%", "", "§a+3.0% §7Healing Rate", "§c-1.6% §7Movement Speed", "", "§9Uncommon"], Name: "§9Steel Chestplate"}});
...
val boots = <atherys:heavy_t2_boots>.withTag({HideFlags: 2, SpongeData: {CustomManipulators: [{ContentVersion: 2, ManipulatorId: "atherysrpg:attributes", ManipulatorData: {ContentVersion: 1, Attributes: {"atherys:physical_resistance": 7.0, "atherys:speed_multiplier": -1.0, "atherys:healing_rate": 1.8, "atherys:magical_resistance": 4.7}}}]}, display: {Lore: ["§7Heavy Armor", "", "§c▶ Physical Resistance§7: +7.0%", "§3▶ Magical Resistance§7: +4.7%", "", "§a+1.8% §7Healing Rate", "§c-1.0% §7Movement Speed", "", "§9Uncommon"], Name: "§9Steel Sabatons"}});
...
val battleaxe = <atherys:battleaxe_t3>.withTag({HideFlags: 2, SpongeData: {CustomManipulators: [{ContentVersion: 2, ManipulatorId: "atherysrpg:attributes", ManipulatorData: {ContentVersion: 1, Attributes: {"atherys:physdmg_multiplier": 4.0, "atherys:base_damage": 25.0}}}]}, display: {Lore: ["§7Battle Axe (Main Hand)", "", "§c▶ Physical Damage§7: 25.0", "§b1.0 §7Attack Speed", "", "§a+4.0% §7Physical Damage", "", "§6Rare"], Name: "§6Fatesteel Battleaxe"}});
val staff = <atherys:staff_t2>.withTag({HideFlags: 2, SpongeData: {CustomManipulators: [{ContentVersion: 2, ManipulatorId: "atherysrpg:attributes", ManipulatorData: {ContentVersion: 1, Attributes: {"atherys:magicdmg_multiplier": 6.0, "atherys:base_damage": 6.5}}}]}, display: {Lore: ["§7Staff (Main Hand)", "", "§c▶ Physical Damage§7: 6.5", "§b3.0 §7Attack Speed", "", "§a+6.0% §7Magical Damage", "", "§9Uncommon"], Name: "§9Azure Staff"}});
...
val scepter = <atherys:scepter_t2>.withTag({HideFlags: 2, SpongeData: {CustomManipulators: [{ContentVersion: 2, ManipulatorId: "atherysrpg:attributes", ManipulatorData: {ContentVersion: 1, Attributes: {"atherys:healing_multiplier": 6.0, "atherys:base_damage": 10.0}}}]}, display: {Lore: ["§7Scepter (Main Hand)", "", "§c▶ Physical Damage§7: 10.0", "§b2.0 §7Attack Speed", "", "§a+6.0% §7Healing Power", "", "§9Uncommon"], Name: "§9Azure Scepter"}});

val pickaxe = <atherys:pickaxe_t2>.withTag({HideFlags: 2, display: {Lore: ["", "§a▶ Mining Speed§7:§6 8.0", "§b◆ Harvest Level§7:§6 4", "", "§9Uncommon"], Name: "§9Steel Pickaxe"}});
val axe = <atherys:axe_t2>.withTag({HideFlags: 2, display: {Lore: ["", "§a▶ Woodcutting Speed§7:§6 8.0", "§b◆ Harvest Level§7:§6 4", "", "§9Uncommon"], Name: "§9Steel Axe"}});
val shovel = <atherys:shovel_t2>.withTag({HideFlags: 2, display: {Lore: ["", "§a▶ Digging Speed§7:§6 8.0", "§b◆ Harvest Level§7:§6 4", "", "§9Uncommon"], Name: "§9Steel Shovel"}});
val hoe = <atherys:hoe_t2>.withTag({HideFlags: 2, display: {Lore: ["", "§a▶ Harvest Speed§7:§6 1.0", "§b◆ Harvest Level§7:§6 4", "", "§9Uncommon"], Name: "§9Steel Hoe"}});
