...
val ingot = <atherys:ingot_t3>.withTag({HideFlags: 2, display: {Lore: ["", "§7Can be crafted into §6Fatesteel§7 Items."], Name: "§6Fatesteel Ingot"}});
val stick = <minecraft:stick>;
val gem = <minecraft:emerald>.withTag({display: {Name: "§r§6Emerald"}});

val helmet = <atherys:heavy_t3_helmet>.withTag({HideFlags: 2, SpongeData: {CustomManipulators: [{ContentVersion: 2, ManipulatorId: "atherysrpg:attributes", ManipulatorData: {ContentVersion: 1, Attributes: {"atherys:physical_resistance": 10.9, "atherys:speed_multiplier": -1.0, "atherys:healing_rate": 2.4, "atherys:magical_resistance": 7.3}}}]}, display: {Lore: ["§7Heavy Armor", "", "§c▶ Physical Resistance§7: +10.9%", "§3▶ Magical Resistance§7: +7.3%", "", "§a+2.4% §7Healing Rate", "§c-1.0% §7Movement Speed", "", "§6Rare"], Name: "§6Fatesteel Helm"}});
val chest = <atherys:heavy_t3_body>.withTag({HideFlags: 2, SpongeData: {CustomManipulators: [{ContentVersion: 2, ManipulatorId: "atherysrpg:attributes", ManipulatorData: {ContentVersion: 1, Attributes: {"atherys:physical_resistance": 17.6, "atherys:speed_multiplier": -1.6, "atherys:healing_rate": 4.0, "atherys:magical_resistance": 11.7}}}]}, display: {Lore: ["§7Heavy Armor", "", "§c▶ Physical Resistance§7: +17.6%", "§3▶ Magical Resistance§7: +11.7%", "", "§a+4.0% §7Healing Rate", "§c-1.6% §7Movement Speed", "", "§6Rare"], Name: "§6Fatesteel Chestplate"}});
...
val staff = <atherys:staff_t3>.withTag({HideFlags: 2, SpongeData: {CustomManipulators: [{ContentVersion: 2, ManipulatorId: "atherysrpg:attributes", ManipulatorData: {ContentVersion: 1, Attributes: {"atherys:magicdmg_multiplier": 8.0, "atherys:base_damage": 8.0}}}]}, display: {Lore: ["§7Staff (Main Hand)", "", "§c▶ Physical Damage§7: 8.0", "§b3.0 §7Attack Speed", "", "§a+8.0% §7Magical Damage", "", "§6Rare"], Name: "§6Emerald Staff"}});
val mace = <atherys:mace_t3>.withTag({HideFlags: 2, SpongeData: {CustomManipulators: [{ContentVersion: 2, ManipulatorId: "atherysrpg:attributes", ManipulatorData: {ContentVersion: 1, Attributes: {"atherys:crowdcontrol_multiplier": 20.0, "atherys:base_damage": 25.0}}}]}, display: {Lore: ["§7Mace (Main Hand)", "", "§c▶ Physical Damage§7: 25.0", "§b1.0 §7Attack Speed", "", "§a+20.0% §7Crowd Control Duration", "", "§6Rare"], Name: "§6Fatesteel Mace"}});
val scepter = <atherys:scepter_t3>.withTag({HideFlags: 2, SpongeData: {CustomManipulators: [{ContentVersion: 2, ManipulatorId: "atherysrpg:attributes", ManipulatorData: {ContentVersion: 1, Attributes: {"atherys:healing_multiplier": 8.0, "atherys:base_damage": 12.5}}}]}, display: {Lore: ["§7Scepter (Main Hand)", "", "§c▶ Physical Damage§7: 12.5", "§b2.0 §7Attack Speed", "", "§a+8.0% §7Healing Power", "", "§6Rare"], Name: "§6Emerald Scepter"}});

val pickaxe = <atherys:pickaxe_t3>.withTag({HideFlags: 2, display: {Lore: ["", "§a▶ Mining Speed§7:§6 9.0", "§b◆ Harvest Level§7:§6 5", "", "§6Rare"], Name: "§6Fatesteel Pickaxe"}});
val axe = <atherys:axe_t3>.withTag({HideFlags: 2, display: {Lore: ["", "§a▶ Woodcutting Speed§7:§6 9.0", "§b◆ Harvest Level§7:§6 5", "", "§6Rare"], Name: "§6Fatesteel Axe"}});
val shovel = <atherys:shovel_t3>.withTag({HideFlags: 2, display: {Lore: ["", "§a▶ Digging Speed§7:§6 9.0", "§b◆ Harvest Level§7:§6 5", "", "§6Rare"], Name: "§6Fatesteel Shovel"}});
val hoe = <atherys:hoe_t3>.withTag({HideFlags: 2, display: {Lore: ["", "§a▶ Harvest Speed§7:§6 1.0", "§b◆ Harvest Level§7:§6 5", "", "§6Rare"], Name: "§6Fatesteel Hoe"}});
